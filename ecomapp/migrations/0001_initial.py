# Generated by Django 5.0.3 on 2024-04-19 05:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('On the way', 'On the way'), ('Order Received', 'Order Received'), ('Order Cancelled', 'Order Cancelled'), ('Order Completed', 'Order Completed'), ('Order pending', 'Order Pending')], max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
