    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Order pending', 'Order Pending'), ('Order Received', 'Order Received'), ('Order Completed', 'Order Completed'), ('Order Cancelled', 'Order Cancelled'), ('On the way', 'On the way')], max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
