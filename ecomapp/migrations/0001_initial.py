    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Order pending', 'Order Pending'), ('Order Received', 'Order Received'), ('Order Completed', 'Order Completed'), ('On the way', 'On the way'), ('Order Cancelled', 'Order Cancelled')], max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecomapp.categpry')),
            ],
        ),
        migrations.CreateModel(
            name='CartProduct',
